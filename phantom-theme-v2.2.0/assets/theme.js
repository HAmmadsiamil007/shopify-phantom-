/*
@license
  PHANTOM by PHANTOM Themes
  Access unminified JS in assets/theme.js

  Use this event listener to run your own JS outside of this file.

  document.addEventListener('phantom:ready', function() {
...
(function(){
  ...
  if (window.Shopify && window.Shopify.theme && navigator && navigator.sendBeacon && window.Shopify.designMode) {
    navigator.sendBeacon('/.well-known/beacon', new URLSearchParams({
  ...
  DOMready(function(){
    ...
    document.dispatchEvent(new CustomEvent('phantom:ready'));
  });
